...
# This class implements a Python interface to the 'Sensing_Humidity'
# message type.
#
...
class Sensing_Humidity(tinyos.message.Message.Message):
    # Create a new Sensing_Humidity of size 6.
