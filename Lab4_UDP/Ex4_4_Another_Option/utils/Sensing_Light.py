...
# This class implements a Python interface to the 'Sensing_Light'
# message type.
#
...
class Sensing_Light(tinyos.message.Message.Message):
    # Create a new Sensing_Light of size 6.
